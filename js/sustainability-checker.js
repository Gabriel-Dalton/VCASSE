document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', (event) => {
    ...
    waterOutput.textContent = `${latestEstimate.waterLiters.toFixed(2)} L`;
    energyOutput.textContent = `${latestEstimate.energyKwh.toFixed(2)} kWh`;
    carbonOutput.textContent = `${latestEstimate.carbonKg.toFixed(2)} kg`;
  ...
  function renderTotals() {
    ...
    sessionWater.textContent = `${totals.waterLiters.toFixed(2)} L`;
    sessionEnergy.textContent = `${totals.energyKwh.toFixed(2)} kWh`;
    sessionCarbon.textContent = `${totals.carbonKg.toFixed(2)} kg CO₂e`;
  }
